...
public class _ts {
    ...
    private static final long _status$OFFSET = 24;
    ...
    private static final long py_recursion_remaining$OFFSET = 28;
    ...
    private static final long py_recursion_limit$OFFSET = 32;
    ...
    private static final long c_recursion_remaining$OFFSET = 36;
    ...
    private static final long what_event$OFFSET = 48;
    ...
    private static final long current_exception$OFFSET = 96;
    ...
    private static final long exc_info$OFFSET = 104;
    ...
    private static final long dict$OFFSET = 112;
    ...
    private static final long gilstate_counter$OFFSET = 120;
    ...
    private static final long async_exc$OFFSET = 128;
    ...
    private static final long thread_id$OFFSET = 136;
    ...
    private static final long native_thread_id$OFFSET = 140;
    ...
    private static final long trash$OFFSET = 144;
    ...
    private static final long on_delete$OFFSET = 160;
    ...
    private static final long on_delete_data$OFFSET = 168;
    ...
    private static final long coroutine_origin_tracking_depth$OFFSET = 176;
    ...
    private static final long async_gen_firstiter$OFFSET = 184;
    ...
    private static final long async_gen_finalizer$OFFSET = 192;
    ...
    private static final long context$OFFSET = 200;
    ...
    private static final long context_ver$OFFSET = 208;
    ...
    private static final long id$OFFSET = 216;
    ...
    private static final long datastack_chunk$OFFSET = 224;
    ...
    private static final long datastack_top$OFFSET = 232;
    ...
    private static final long datastack_limit$OFFSET = 240;
    ...
    private static final long exc_state$OFFSET = 248;
    ...
    private static final long root_cframe$OFFSET = 264;
