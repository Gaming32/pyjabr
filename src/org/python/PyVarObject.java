...
public class PyVarObject {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_LONG_LONG.withName("ob_size")
    ).withName("$anon$196:9");
    ...
    private static final OfLong ob_size$LAYOUT = (OfLong)$LAYOUT.select(groupElement("ob_size"));
     ...
     * }
     */
    public static final OfLong ob_size$layout() {
        return ob_size$LAYOUT;
    }

    private static final long ob_size$OFFSET = 16;
     ...
     * }
     */
    public static final long ob_size$offset() {
        return ob_size$OFFSET;
    }
     ...
     * }
     */
    public static long ob_size(MemorySegment struct) {
        return struct.get(ob_size$LAYOUT, ob_size$OFFSET);
    }
     ...
     * }
     */
    public static void ob_size(MemorySegment struct, long fieldValue) {
        struct.set(ob_size$LAYOUT, ob_size$OFFSET, fieldValue);
    }
