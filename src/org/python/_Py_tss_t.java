...
public class _Py_tss_t {
    ...
    private static final OfInt _key$LAYOUT = (OfInt)$LAYOUT.select(groupElement("_key"));
     ...
     * }
     */
    public static final OfInt _key$layout() {
        return _key$LAYOUT;
    }

    private static final long _key$OFFSET = 4;
     ...
     * }
     */
    public static int _key(MemorySegment struct) {
     ...
     * }
     */
    public static void _key(MemorySegment struct, int fieldValue) {
