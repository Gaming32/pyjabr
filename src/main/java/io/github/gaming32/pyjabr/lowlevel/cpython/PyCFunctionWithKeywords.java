 ...
 * }
 */
public class PyCFunctionWithKeywords {
    ...
    private static final MethodHandle UP$MH = Python_h.upcallHandle(PyCFunctionWithKeywords.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PyCFunctionWithKeywords.Function fi, Arena arena) {
