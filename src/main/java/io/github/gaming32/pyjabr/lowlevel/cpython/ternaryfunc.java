...
public class ternaryfunc {
    ...
    private static final MethodHandle UP$MH = Python_h.upcallHandle(ternaryfunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(ternaryfunc.Function fi, Arena arena) {
