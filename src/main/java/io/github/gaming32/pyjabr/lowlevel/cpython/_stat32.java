...
public class _stat32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_LONG.withName("st_atime"),
        Python_h.C_LONG.withName("st_mtime"),
        Python_h.C_LONG.withName("st_ctime")
    ).withName("_stat32");
    ...
    private static final OfInt st_atime$LAYOUT = (OfInt)$LAYOUT.select(groupElement("st_atime"));
     ...
     * }
     */
    public static final OfInt st_atime$layout() {
     ...
     * }
     */
    public static int st_atime(MemorySegment struct) {
     ...
     * }
     */
    public static void st_atime(MemorySegment struct, int fieldValue) {
        struct.set(st_atime$LAYOUT, st_atime$OFFSET, fieldValue);
    }

    private static final OfInt st_mtime$LAYOUT = (OfInt)$LAYOUT.select(groupElement("st_mtime"));
     ...
     * }
     */
    public static final OfInt st_mtime$layout() {
        return st_mtime$LAYOUT;
    }

    private static final long st_mtime$OFFSET = 28;
     ...
     * }
     */
    public static int st_mtime(MemorySegment struct) {
     ...
     * }
     */
    public static void st_mtime(MemorySegment struct, int fieldValue) {
        struct.set(st_mtime$LAYOUT, st_mtime$OFFSET, fieldValue);
    }

    private static final OfInt st_ctime$LAYOUT = (OfInt)$LAYOUT.select(groupElement("st_ctime"));
     ...
     * }
     */
    public static final OfInt st_ctime$layout() {
        return st_ctime$LAYOUT;
    }

    private static final long st_ctime$OFFSET = 32;
     ...
     * }
     */
    public static int st_ctime(MemorySegment struct) {
     ...
     * }
     */
    public static void st_ctime(MemorySegment struct, int fieldValue) {
