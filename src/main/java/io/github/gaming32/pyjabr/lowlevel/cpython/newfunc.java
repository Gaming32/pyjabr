...
public class newfunc {
    ...
    private static final MethodHandle UP$MH = Python_h.upcallHandle(newfunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(newfunc.Function fi, Arena arena) {
