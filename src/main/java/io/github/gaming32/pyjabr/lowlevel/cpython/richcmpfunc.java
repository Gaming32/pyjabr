...
public class richcmpfunc {
    ...
    private static final MethodHandle UP$MH = Python_h.upcallHandle(richcmpfunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(richcmpfunc.Function fi, Arena arena) {
