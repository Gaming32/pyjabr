...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Python_h.C_INT.withName("tm_sec"),
        Python_h.C_INT.withName("tm_min"),
        Python_h.C_INT.withName("tm_hour"),
        Python_h.C_INT.withName("tm_mday"),
        Python_h.C_INT.withName("tm_mon"),
        Python_h.C_INT.withName("tm_year"),
        Python_h.C_INT.withName("tm_wday"),
        Python_h.C_INT.withName("tm_yday"),
        Python_h.C_INT.withName("tm_isdst")
    ).withName("tm");
