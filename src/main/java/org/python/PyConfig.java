...
public class PyConfig {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_INT.withName("legacy_windows_stdio"),
        MemoryLayout.paddingLayout(4),
    ...
    private static final OfInt hash_seed$LAYOUT = (OfInt)$LAYOUT.select(groupElement("hash_seed"));
     ...
     * }
     */
    public static final OfInt hash_seed$layout() {
     ...
     * }
     */
    public static int hash_seed(MemorySegment struct) {
     ...
     * }
     */
    public static void hash_seed(MemorySegment struct, int fieldValue) {
    ...
    private static final long faulthandler$OFFSET = 28;
    ...
    private static final long tracemalloc$OFFSET = 32;
    ...
    private static final long perf_profiling$OFFSET = 36;
    ...
    private static final long import_time$OFFSET = 40;
    ...
    private static final long code_debug_ranges$OFFSET = 44;
    ...
    private static final long show_ref_count$OFFSET = 48;
    ...
    private static final long dump_refs$OFFSET = 52;
    ...
    private static final long dump_refs_file$OFFSET = 56;
    ...
    private static final long malloc_stats$OFFSET = 64;
    ...
    private static final long filesystem_encoding$OFFSET = 72;
    ...
    private static final long filesystem_errors$OFFSET = 80;
    ...
    private static final long pycache_prefix$OFFSET = 88;
    ...
    private static final long parse_argv$OFFSET = 96;
    ...
    private static final long orig_argv$OFFSET = 104;
    ...
    private static final long argv$OFFSET = 120;
    ...
    private static final long xoptions$OFFSET = 136;
    ...
    private static final long warnoptions$OFFSET = 152;
    ...
    private static final long site_import$OFFSET = 168;
    ...
    private static final long bytes_warning$OFFSET = 172;
    ...
    private static final long warn_default_encoding$OFFSET = 176;
    ...
    private static final long inspect$OFFSET = 180;
    ...
    private static final long interactive$OFFSET = 184;
    ...
    private static final long optimization_level$OFFSET = 188;
    ...
    private static final long parser_debug$OFFSET = 192;
    ...
    private static final long write_bytecode$OFFSET = 196;
    ...
    private static final long verbose$OFFSET = 200;
    ...
    private static final long quiet$OFFSET = 204;
    ...
    private static final long user_site_directory$OFFSET = 208;
    ...
    private static final long configure_c_stdio$OFFSET = 212;
    ...
    private static final long buffered_stdio$OFFSET = 216;
    ...
    private static final long stdio_encoding$OFFSET = 224;
    ...
    private static final long stdio_errors$OFFSET = 232;
    ...
    private static final OfInt legacy_windows_stdio$LAYOUT = (OfInt)$LAYOUT.select(groupElement("legacy_windows_stdio"));
     ...
     * }
     */
    public static final OfInt legacy_windows_stdio$layout() {
        return legacy_windows_stdio$LAYOUT;
    }

    private static final long legacy_windows_stdio$OFFSET = 240;
     ...
     * }
     */
    public static final long legacy_windows_stdio$offset() {
        return legacy_windows_stdio$OFFSET;
    }
     ...
     * }
     */
    public static int legacy_windows_stdio(MemorySegment struct) {
        return struct.get(legacy_windows_stdio$LAYOUT, legacy_windows_stdio$OFFSET);
    }
     ...
     * }
     */
    public static void legacy_windows_stdio(MemorySegment struct, int fieldValue) {
        struct.set(legacy_windows_stdio$LAYOUT, legacy_windows_stdio$OFFSET, fieldValue);
    }
    ...
    private static final long pathconfig_warnings$OFFSET = 268;
    ...
    private static final long program_name$OFFSET = 272;
    ...
    private static final long pythonpath_env$OFFSET = 280;
    ...
    private static final long home$OFFSET = 288;
    ...
    private static final long platlibdir$OFFSET = 296;
    ...
    private static final long module_search_paths_set$OFFSET = 304;
    ...
    private static final long module_search_paths$OFFSET = 312;
    ...
    private static final long stdlib_dir$OFFSET = 328;
    ...
    private static final long executable$OFFSET = 336;
    ...
    private static final long base_executable$OFFSET = 344;
    ...
    private static final long prefix$OFFSET = 352;
    ...
    private static final long base_prefix$OFFSET = 360;
    ...
    private static final long exec_prefix$OFFSET = 368;
    ...
    private static final long base_exec_prefix$OFFSET = 376;
    ...
    private static final long skip_source_first_line$OFFSET = 384;
    ...
    private static final long run_command$OFFSET = 392;
    ...
    private static final long run_module$OFFSET = 400;
    ...
    private static final long run_filename$OFFSET = 408;
    ...
    private static final long _install_importlib$OFFSET = 416;
    ...
    private static final long _init_main$OFFSET = 420;
    ...
    private static final long _is_python_build$OFFSET = 424;
