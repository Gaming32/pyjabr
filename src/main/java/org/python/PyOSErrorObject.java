...
public class PyOSErrorObject {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_POINTER.withName("myerrno"),
        Python_h.C_POINTER.withName("strerror"),
        Python_h.C_POINTER.withName("filename"),
        Python_h.C_POINTER.withName("filename2"),
        Python_h.C_POINTER.withName("winerror"),
        Python_h.C_LONG_LONG.withName("written")
    ).withName("$anon$57:9");
    ...
    private static final AddressLayout myerrno$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("myerrno"));
     ...
     * }
     */
    public static final AddressLayout myerrno$layout() {
        return myerrno$LAYOUT;
    }

    private static final long myerrno$OFFSET = 72;
     ...
     * }
     */
    public static final long myerrno$offset() {
        return myerrno$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment myerrno(MemorySegment struct) {
        return struct.get(myerrno$LAYOUT, myerrno$OFFSET);
    }
     ...
     * }
     */
    public static void myerrno(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(myerrno$LAYOUT, myerrno$OFFSET, fieldValue);
    }

    private static final AddressLayout strerror$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("strerror"));
     ...
     * }
     */
    public static final AddressLayout strerror$layout() {
        return strerror$LAYOUT;
    }

    private static final long strerror$OFFSET = 80;
     ...
     * }
     */
    public static final long strerror$offset() {
     ...
     * }
     */
    public static MemorySegment strerror(MemorySegment struct) {
        return struct.get(strerror$LAYOUT, strerror$OFFSET);
    }
     ...
     * }
     */
    public static void strerror(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(strerror$LAYOUT, strerror$OFFSET, fieldValue);
    }
    ...
    private static final AddressLayout filename2$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("filename2"));
     ...
     * }
     */
    public static final AddressLayout filename2$layout() {
        return filename2$LAYOUT;
    }

    private static final long filename2$OFFSET = 96;
     ...
     * }
     */
    public static final long filename2$offset() {
        return filename2$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment filename2(MemorySegment struct) {
        return struct.get(filename2$LAYOUT, filename2$OFFSET);
    }
     ...
     * }
     */
    public static void filename2(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(filename2$LAYOUT, filename2$OFFSET, fieldValue);
    }

    private static final AddressLayout winerror$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("winerror"));
     ...
     * }
     */
    public static final AddressLayout winerror$layout() {
        return winerror$LAYOUT;
    }

    private static final long winerror$OFFSET = 104;
     ...
     * }
     */
    public static final long winerror$offset() {
        return winerror$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment winerror(MemorySegment struct) {
        return struct.get(winerror$LAYOUT, winerror$OFFSET);
    }
     ...
     * }
     */
    public static void winerror(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(winerror$LAYOUT, winerror$OFFSET, fieldValue);
    }

    private static final OfLong written$LAYOUT = (OfLong)$LAYOUT.select(groupElement("written"));
     ...
     * }
     */
    public static final OfLong written$layout() {
        return written$LAYOUT;
    }

    private static final long written$OFFSET = 112;
     ...
     * }
     */
    public static long written(MemorySegment struct) {
     ...
     * }
     */
    public static void written(MemorySegment struct, long fieldValue) {
